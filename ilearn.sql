...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2017 at 09:16 PM
...
CREATE TABLE `users` (
  ...
  `password` varchar(20) NOT NULL,
  `CourseOne` varchar(10) DEFAULT NULL,
  `CourseTwo` varchar(10) DEFAULT NULL,
  `CourseThree` varchar(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(235, 'kyle', 'wilson', 'kwwils', '123', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(236, 'qwe', 'asdas', 'dasd', 'asd', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(237, 'weff', 'wef', 'fwef', '123', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(238, 'wef', 'wef', 'fwe', 'wef', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(239, 'sds', 'sdf', 'sdf', '123', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(240, '123', 'wer', 'wer', '123', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(241, 'werwer', 'werwer', 'werwer', 'qwe', 'CSCI3000', 'CSCI4500', 'CSCI1301'),
(242, 'first', 'last', 'fwefwef', '123', 'CSCI3000', 'CSCI4500', 'CSCI1301');
...
--
ALTER TABLE `student`
  ADD CONSTRAINT `Student_ibfk_1` FOREIGN KEY (`Studentid`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `teacher`
--
ALTER TABLE `teacher`
  ADD CONSTRAINT `teacher_ibfk_1` FOREIGN KEY (`teacherId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
